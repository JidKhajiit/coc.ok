...
const ru: Dict = {
  ...
  'share.settingsHint': 'Другие игроки смогут смотреть вашу коллекцию и список нужных карт по ссылке.',
  ...
  'share.collectionStats': '{owned} из {total} карт · {needed} нужных',
...
const en: Dict = {
  ...
  'share.settingsHint': 'Other players can view your collection and needed cards via a link.',
  ...
  'share.collectionStats': '{owned} of {total} cards · {needed} needed',
